...
function renderHiveVerdict(verdict) {
        ...
        for (const vote of verdict.votes) {
            votesHtml += `
                <div class="verdict-vote">
                    ${vote.emoji ? `<span class="emoji">${escapeHtml(vote.emoji)}</span>` : `<img src="/bee-icon.png" alt="" class="emoji" style="width: 48px; height: 48px; background: #ffffff; border-radius: 50%;">`}
    ...
    verdictEl.innerHTML = `
        <div class="verdict-decision">
            <img src="/bee-icon.png" alt="" class="verdict-bee" style="width: 80px; height: 80px; background: #ffffff; border-radius: 50%;">
