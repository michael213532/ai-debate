...
Example format:
{{"title":"The Great Slice Showdown","votes":[{{"name":"Analyst","choice":"Pizza","reason":"Better value and more variety"}},{{"name":"Skeptic","choice":"Burger","reason":"Higher quality ingredients"}}],"hive_decision":"Pizza"}}

Rules:
- "title" = a short, funny, catchy headline for this debate (5-8 words max, like a tabloid headline or podcast episode title). Must relate to the actual topic.
- Extract the ACTUAL final answer each AI chose (e.g., "Pizza", "Option A", "Yes", "iPhone 15")
- "reason" = 1 sentence explaining WHY they chose it - include their key argument or reasoning (max 20 words)
